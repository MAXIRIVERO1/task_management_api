...
const { deleteTaskController } = require("../controllers/taskController.js");
 taskRouter
.post("/create", createTaskController); taskRouter
.get("/getAll", getAllTaskController); taskRouter
.get("/:id", getTaskByIdController); taskRouter
.put("/update/:id", putTaskController); taskRouter
.delete("/delete/:id", deleteTaskController);
